...
object TestLinkImporter {
    suspend fun import(context: Context, uri: Uri): String? {
        ...
        val questions = JeeRepository(context).parseQuestions(payload.questionsJson)
        ...
        val test = JeeTestEntity(
            ...
            questionsJson = converters.fromQuestionList(questions),
            isSample = false,
        ...
        JeeRepository(context).insertTest(test, questions)
        return test.testId
    }
}
